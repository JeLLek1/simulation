...
{
	sf::Vector2i begin = sf::Vector2i(SimulationStateMain::isoToCart( camPosIso - (camSize * 0.5f), this->mapSize.x));
	sf::Vector2i end = sf::Vector2i(SimulationStateMain::isoToCart(camPosIso + (camSize * 0.5f), this->mapSize.x));
